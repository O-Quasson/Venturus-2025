https://prod.liveshare.vsengsaas.visualstudio.com/join?191040A8946D5A4583C54C1811D220DC9744
...
Está liberado o uso de APIs externas, desde que estejam documentadas no arquivo README no momento da entrega. Todas as tabelas do banco de dados devem conter campos de “createdAt“ e “updatedAt” de identificação, timestamps e validações coerentes.
...
Descrição: Lista os animais disponíveis para adoção com suporte a filtros (espécie, porte, castrado etc.). Ordena por padrão do mais antigo para o mais recente.
